    ...
    public void setCollapsed(boolean val) {
        ...
        if (isAnimated() && isShowing()) {
            ...
            if (oldValue) {
                ...
                int preferredDimension = direction.isVertical() ? getContentPane().getPreferredSize().height
